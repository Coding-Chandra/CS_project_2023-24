...
#Created on Mon Jan 18 09:23: 2023
'''
@author: Nish
'''
#Smiple UI
...
print('|!!!!!!!*******₹₹₹₹₹₹₹ WELCOME TO Quizo ₹₹₹₹₹₹₹*******!!!!!!!|')
print("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾")
print("______________________________________________________________")
print("|※※※⁂⁂⁂[[[THIS QUIZ APP IS DEVELOPED BY NISHANT]]]⁂⁂⁂※※※|")
print("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾")
...
print('|3.Game will get over as soon as you give wrong answer.|')
print("‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾")
print(" SO LETS BEGIN..........!")
#question bank
...
while count<=4:
  ...
  if first==c:
    ...
    if second==a:
        ...
        if third==d:
            ...
            if fourth==c:
                ...
                if fifth==b:
                    ...
                    print("-----------------------------------------------------------------------------------------------------")
                    print("Re Run Code to play again")
                    print("-----------------------------------------------------------------------------------------------------")
                else:
                    print("-----------------------------------------------------------------------------------------------------")
                    print('ಥ_ಥ Bad luck :/, your answer is not correct. The correct answer was option b. Your total score is 40 points.Thank you for playing this game :)')
                    print("-----------------------------------------------------------------------------------------------------")
                    print("Re Run Code to play again")
                    print("-----------------------------------------------------------------------------------------------------")
                    break
                ...
                print("-----------------------------------------------------------------------------------------------------")
                print('ಥ_ಥ Bad luck :/, your answer is not correct. The correct answer was option c. Your total score is 30 points.Thank you for playing this game :)')
                print("-----------------------------------------------------------------------------------------------------")
                print("Re Run Code to play again")
                print("-----------------------------------------------------------------------------------------------------")
        else:
            print("-----------------------------------------------------------------------------------------------------")
            print('ಥ_ಥ Bad luck :/, your answer is not correct. The correct answer was option d. Your total score is 20 points.Thank you for playing this game :)')
            print("-----------------------------------------------------------------------------------------------------")
            print("Re Run Code to play again")
            print("-----------------------------------------------------------------------------------------------------")
            break
        ...
        print("-----------------------------------------------------------------------------------------------------")
        print("ಥ_ಥ Bad luck :/, your answer is not correct. The correct answer was option a. Your total score is 10 points.Thank you for playing this game :)")
        print("-----------------------------------------------------------------------------------------------------")
        print("Re Run Code to play again")
        print("-----------------------------------------------------------------------------------------------------")
        break
   ...
   print("-----------------------------------------------------------------------------------------------------")
   print("ಥ_ಥ Bad luck :/, your answer is not correct. The correct answer was option c.Your score is 0 points.Thank you for playing this game :)")
   print("-----------------------------------------------------------------------------------------------------")
   print("Re Run Code to play again")
   print("-----------------------------------------------------------------------------------------------------")
  break
